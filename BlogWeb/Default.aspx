...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#awards">Projelerim</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container-fluid p-0">
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="experience">
            ...
            <div class="my-auto">
                <h2 class="mb-5">Deneyimlerim / Experience</h2>
                    ...
                    <ItemTemplate>
                        <div class="resume-item d-flex flex-column flex-md-row mb-5">
                            ...
                            <div class="resume-date text-md-right">
                                <span class="text-primary">
                                    <asp:Label ID="Label10" runat="server" Text='<%#Eval("TARIH_BAS") %>'></asp:Label>
                                    -
                                    <asp:Label ID="Label11" runat="server" Text='<%#Eval("TARIH_SON") %>'></asp:Label></span>
                            </div>
                        </div>
                    </ItemTemplate>
                </asp:Repeater>
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="education">
            ...
            <div class="my-auto">
                <h2 class="mb-5">Eğitim Hayatım / Education</h2>
                <asp:Repeater ID="Repeater3" runat="server">
                    <ItemTemplate>
                        <div class="resume-item d-flex flex-column flex-md-row mb-5">
                            <div class="resume-content mr-auto">
                                <h3 class="mb-0">
                                    <asp:Label ID="Label12" runat="server" Text='<%#Eval("BASLIK") %>'></asp:Label></h3>
                                <div class="subheading mb-3">
                                    <asp:Label ID="Label13" runat="server" Text='<%#Eval("ALTBASLIK") %>'></asp:Label>
                                </div>
                                <div>
                            ...
                            <div class="resume-date text-md-right">
                                <span class="text-primary">
                                    <asp:Label ID="Label16" runat="server" Text='<%#Eval("TARIH") %>'></asp:Label></span>
                            </div>
                        </div>
                    </ItemTemplate>
                </asp:Repeater>
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="skills">
            <div class="my-auto">
                <h2 class="mb-5">Yeteneklerim / Skills</h2>

                <div class="subheading mb-3">Programlama Dilleri / Programming Languages &amp; Tools</div>
                ...
                <div class="subheading mb-3">İş Akışı / Workflow</div>
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="interests">
            <div class="my-auto">
                <h2 class="mb-5">Hobilerim / Interests</h2>
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="awards">
            <div class="my-auto">
                <h2 class="mb-5">Projelerim / Projects &amp; Sertifikalar / Certifications </h2>
                <asp:Repeater ID="Repeater6" runat="server">
                    <ItemTemplate>
                        <ul class="fa-ul mb-0">
                            <div>
                                <i class="fa-li fa fa-trophy text-warning"></i>
                                <asp:Label ID="Label18" runat="server" Text='<%#Eval("PROJELER") %>'></asp:Label>
                            </div>
                            <div>
                                <asp:Label ID="Label14" runat="server" Text='<%#Eval("ACIKLAMALAR") %>'></asp:Label>
                            </div>
